...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~tB5zQDxI#2dA5jUNTZ___t-GiSf0puGLPQbZPavIzjmgWXvbClWE",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50935827369",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "CHRIST2.0",           // Owner's name
    
    DEV: process.env.DEV || "50935827369",                     // Developer's contact number
